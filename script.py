...
### Please adjust the BOARD_SIZE in config.py you want to play
...
if __name__ == "__main__":
    ...
    board_size = int(input("Which Boardsize do you want to play? Make also sure BOARD_SIZE in config.py is correctly adjusted (Default=7)!\nPress 3, 4, 5 or 7: "))
